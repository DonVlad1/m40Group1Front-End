...
const Signup = ({setter, setLoggedIn, setToken, setter2, darkMode, setter3, setBio, setDarkMode}) => {
  ...
  const submitHandler = async (event) => {
    ...
    let token = await signup(username, email, password, phone, setter, setLoggedIn, setter2, navigate, setter3, setBio, setDarkMode)
    setToken(token)
  }
